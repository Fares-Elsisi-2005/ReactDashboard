...
import "react-pro-sidebar/dist/css/styles.css"; // Works with v0.7.1
...
// MUI Icons (corrected names and paths)
...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
    ...
    return (
        <Box
            ...
            <ProSidebar collapsed={isCollapsed} breakPoint= {isCollapsed?"md":""} >
                    ...
                    {!isCollapsed && (
                        <Box mb="25px">
                            ...
                            <Box textAlign="center">
                                <Typography variant="h2" color={colors.gray[100]} fontWeight="bold" sx={{m:"10px 0 0 0"}}>Fares Ahmed</Typography>
